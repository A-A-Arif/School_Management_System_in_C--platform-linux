	...
	data:
		{
			...
			if(dis=='y' || dis=='Y' )
			{
				...
				{
					system("gedit cls1stulst.txt cls1result.txt cls1stugrdcell.txt");
				...
				{
					system("gedit cls2stulst.txt cls2result.txt cls2stugrdcell.txt");
					printf("\t\t\t\t >>Task Done Successfully<< \n\n");
					ct2:
					printf("\t\t\t\t 1.Logout From Data Editing\n");
					printf("\t\t\t\t 2.Logout\n");
				...
				{
					system("gedit cls3stulst.txt cls3result.txt cls3stugrdcell.txt");
					printf("\t\t\t\t >>Task Done Successfully<< \n\n");
					ct3:
					printf("\t\t\t\t 1.Logout From Data Editing\n");
					printf("\t\t\t\t 2.Logout\n");
				...
				{
					system("gedit cls4stulst.txt cls4result.txt cls4stugrdcell.txt");
					printf("\t\t\t\t >>Task Done Successfully<< \n\n");
					ct4:
					printf("\t\t\t\t 1.Logout From Data Editing\n");
					printf("\t\t\t\t 2.Logout\n");
				...
				{
					system("gedit cls5stulst.txt cls5result.txt cls5stugrdcell.txt");
					printf("\t\t\t\t >>Task Done Successfully<< \n\n");
					ct5:
					printf("\t\t\t\t 1.Logout From Data Editing\n");
					printf("\t\t\t\t 2.Logout\n");
